        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full py-3 pr-10 border-b border-charcoal/20 focus:border-gold outline-none transition font-sans bg-transparent"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3.5 bg-gold text-navy-dark font-sans font-medium rounded-lg hover:bg-gold-light transition-all duration-300 shadow-md disabled:opacity-60"
            >
              {loading ? (
          ...
          <div className="mt-8 flex items-center gap-4">
            ...
            <span className="font-sans text-sm text-charcoal/40">or continue with</span>
            <div className="flex-1 h-px bg-charcoal/10" />
          </div>
          ...
          <div className="mt-6 grid grid-cols-2 gap-3">
            ...
            <button
              ...
              disabled={loading}
              className="flex items-center justify-center gap-2.5 py-3 border border-charcoal/15 rounded-lg font-sans text-sm font-medium text-navy hover:bg-cream hover:border-charcoal/25 transition-all duration-300 disabled:opacity-60"
            >
            ...
            <button
              onClick={handleSocialLogin}
              disabled={loading}
              className="flex items-center justify-center gap-2.5 py-3 border border-charcoal/15 rounded-lg font-sans text-sm font-medium text-navy hover:bg-charcoal hover:text-white hover:border-charcoal transition-all duration-300 disabled:opacity-60"
            >
