      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <div className="mt-8 flex items-center gap-4">
            ...
            <span className="font-sans text-sm text-charcoal/40">or</span>
            <div className="flex-1 h-px bg-charcoal/10" />
          </div>

          {/* Google */}
          <button className="mt-6 w-full flex items-center justify-center gap-3 py-3.5 border border-charcoal/20 rounded-lg font-sans text-sm font-medium text-navy hover:bg-cream transition-colors">
